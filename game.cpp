/*
Programming by Shivam Gupta
You can add your own levels as per requirement by manipulating the levels array
Algorithm for liner search is implimented due to less expectancy of players, if efficiency is requred then datastructures should be
	manipulated so should be the algorithms
This program illustrates basic keybord input schemes
*/
#include<iostream>
#include<windows.h>
#include<iomanip>
